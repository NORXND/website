	...
	return (
		<React.Fragment>
			<Helmet>
				<link
					rel="canonical"
					href={`https://norxnd.com${window.location.pathname}`}
				/>
				...
				<meta
					name="og:url"
					content={`https://norxnd.com${window.location.pathname}`}
				/>
				<meta
					name="og:description"
					content="404 - Page not found! - NORXND"
			...
			<div className={styles.container}>
				...
				<p className={styles.text}>
					<Trans i18nKey="404-Text" t={props.t}>
						Oopsie, our qualified tracking dogs were searching here
						and there but they couldn't find{' '}
						{window.location.pathname} on this website! It probably
						doesn't exist! 😱
					</Trans>
				</p>
			</div>
