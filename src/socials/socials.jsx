...
function Socials(props) {
	...
	return (
		<React.Fragment>
			<Helmet>
				<link rel="canonical" href="https://norxnd.com/socials" />
				...
				<meta name="og:url" content="https://norxnd.com/socials" />
				<meta
					name="og:description"
					content="Official Socials Page for NORXND."
				/>
			...
			<div className={styles.socials_container}>
				<h1 className={styles.socials_title}>
					{props.t('Socials-Title')}
				</h1>
				{content}
				<p className={styles.socials_notice}>
					<Trans i18nKey="Socials-Notice" t={props.t}>
						...
						<Link
							className={styles.socials_notice_link}
							to="/contact"
						>
							contacting me
						</Link>
