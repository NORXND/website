    ...
    <div className={styles.container}>
      <div className={styles.window}>
        ...
        <p className={styles.text}>
          Blah blah blah in order for every extra features in this site to be
          enabled, we will need to store some data (called cookies) on your
          device. because of EU law we need to tell you about this. just click
          the button below, thats it!
        </p>
