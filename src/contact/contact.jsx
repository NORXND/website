...
function Contact(props) {
	...
	return (
		<React.Fragment>
			<Helmet>
				<link rel="canonical" href="https://norxnd.com/contact" />
				...
				<meta name="og:url" content="https://norxnd.com/contact" />
				<meta
					name="og:description"
					content="Official Contact Page for NORXND."
				/>
			...
			<div className={styles.contact_container}>
				...
				<p>
					<Trans i18nKey="Contact-Notice" t={props.t}>
						Some of my{' '}
						<Link
							className={styles.contacts_notice_link}
							to="/socials"
						>
							social media platforms
						</Link>{' '}
						got an option to send a message. You can also contact me
						that way! Just note, I will answer faster if you use
						sites listed above ;)
					</Trans>
				</p>
			</div>
