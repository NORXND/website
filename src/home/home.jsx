...
function Home(props) {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <link rel="canonical" href="https://norxnd.cf" />
        <title>{props.t("Title-Home")}</title>
        <meta name="description" content="Official Website of NORXND." />

        <meta name="og:title" content="Home - NORXND" />
        <meta name="og:site_name" content="NORXND - Official Website" />
        <meta name="og:url" content="https://norxnd.cf" />
        <meta name="og:description" content="Official Website of NORXND." />
          ...
          <div className={main_styles.col}>
            ...
            <p>
              <Trans i18nKey="Home-Message_2" t={props.t}>
                ...
                page! On the right side, you can see my feed. More you can find
                on the{" "}
