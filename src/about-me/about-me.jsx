					...
					<div className={`${main_styles['col']}`}>
						...
						<p>
							<Trans i18nKey="AboutMe-Main" t={props.t}>
								...
								apps to make people happy.
								<br />I sometimes play some games like FE2 (on
								Roblox), GTA V, Portal 2, Subnautica or
								something else.
								<br />
								You probably know me because I'm a friend of the
								founder and former owner of the popular Roblox
								game. In 2021, I worked with him in the
								"Inertia" games studio which was eventually
								closed.
								<br />
								...
								commission (Stay tuned for that!).
								<br />
								...
								<br />
								I'm a furry. Yes. <br />
								That's all that you should know about me, I
								think so at least. Have any more questions,
								don't hesitate to contact me, I'm very friendly
								and like to talk with people, alternatively join
								my{' '}
								<a
