  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Official About Me Page for NORXND." />
          ...
          <div className={`${main_styles["col"]}`}>
            ...
            <p>
              <Trans i18nKey="AboutMe-Main" t={props.t}>
                I'm NORXND, also known by my real name Norbert. I'm a
                15-year-old guy living in Koszalin, Poland.
                <br></br>
                I'm a hobbyist programming student. I also sometimes produce
                music and make graphics (You could notice I'm obsessed with
                CANAL+ and other Étienne Robial's work).
                <br></br>
                I'm programming in Python, Lua (and Luau), C# and know the
                basics of JS, I can also do websites both in the traditional way
                or in React. In the future, I want to become a freelancer
                software developer, create games and apps to make people happy.
                <br></br>I sometimes play some games like FE2 (on Roblox), GTA
                V, Portal 2, Subnautica or something else.
                <br></br>You probably know me because I'm a friend of the
                founder and former owner of the popular Roblox game. In 2021, I
                worked with him in the "Inertia" games studio which was
                eventually closed.
                ...
                For now, I'm not open for commissions or jobs but soon, I plan
                to open a website-making commission (Stay tuned for that!).
                <br></br>
                What am I doing right now? Check the{" "}
                <Link to="/work">Work</Link> page. Where can you find me? Check
                the <Link to="/socials">Socials</Link> page.
                <br></br>I'm a furry. Yes. <br></br>That's all that you should
                know about me, I think so at least. Have any more questions,
                don't hesitate to contact me, I'm very friendly and like to talk
                with people, alternatively join my{" "}
